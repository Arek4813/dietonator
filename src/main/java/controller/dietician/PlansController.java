...
import controller.admin.plan.MealsOfPlanController;
            ...
            protected void updateItem(PlanFx item, boolean empty) {
                ...
                if (!empty) {
                    ...
                    button.setOnAction(event -> {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/dietician/mealsOfPlan.fxml"));
                        try {
                            borderPane.setCenter(loader.load());
                            PlansMealsController controller = loader.getController();
